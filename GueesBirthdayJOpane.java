import javax.swing.JOptionPane; //pedir info de forma visual
//import java.util.Scanner;
public class GueesBirthdayJOpane{
  public static void main(String[] args) {
    ...
    int day=0;
int answer = JOptionPane.showConfirmDialog(null, "is your birthday in set 1??\n" + set1);
